...
- No CI/CD pipeline exists; tests and lint run locally/manually only. A GitHub Actions workflow running pytest and ruff on every push would be the natural next step.
